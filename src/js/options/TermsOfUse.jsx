                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <div className="content">
                                        ...
                                        <p>If you are located outside France and choose to provide information to us,
                                            please note that we transfer the data, including Personal Data, to France
                                        ...
                                        <ul>
                                            <li>By email: stephan.kouadio@gmail.com</li>
...
export default hot(module)(TermsOfUse)
